...
namespace ChatChannelService.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250503193338_RenamedFieldFromIsPrivateToIsPublic")]
    partial class RenamedFieldFromIsPrivateToIsPublic
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatChannelService.Core.Entities.Message", b =>
                {
                    ...
                    b.HasOne("ChatChannelService.Core.Entities.ChatUser", "Sender")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("ChatChannelService.Core.Entities.Server", b =>
                {
                    b.HasOne("ChatChannelService.Core.Entities.ChatUser", "Owner")
                        .WithMany()
