...
const KEYWORDS: Record<string, string> = {
  ...
  '🤒': 'болен sick fever', '🤢': 'тошнота nausea', '🤮': 'рвота vomit', '🤧': 'чихание sneeze', '🥵': 'жарко hot', '🥶': 'холодно cold', '🥴': 'пьяный woozy', '😵': 'головокружение dizzy', '🤯': 'взрыв мозга exploding head', '😳': 'смущён flushed',
